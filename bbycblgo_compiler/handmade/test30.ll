...
@.str_lit2 = private unnamed_addr constant [8 x i8] c"Skipped\00", align 1
@.str_newline3 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@.str_lit4 = private unnamed_addr constant [8 x i8] c"Altered\00", align 1
@.str_format_lit5 = private unnamed_addr constant [5 x i8] c"%.*s\00", align 1
@.str_lit6 = private unnamed_addr constant [8 x i8] c"Altered\00", align 1
...
entry:
  ...
  %2 = call i32 (ptr, ...) @printf(ptr @.str_format_lit5, i32 7, ptr @.str_lit6)
